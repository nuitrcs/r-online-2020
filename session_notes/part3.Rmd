...
**EXERCISE**: Run the code at least in the Setup and Data sections above first.  Then make a boxplot using the penguins data of `bill_length_mm` (y) by `species` (x).  Check the ggplot2 cheat sheet to find the right geom to use.  If you get done quickly, try labeling your plot.
